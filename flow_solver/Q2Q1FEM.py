...
Main Function
"""
def Q2Q1FEM(Node,Element,NodeBC,Node_P,Element_P,NodeBC_P,zIni,q):
    ...
    E,dEdy,V,dVdy = MatIntFnc(P*z,np.array([fem_mu0,q]))
    E_P,dEdy_P,V_P,dVdy_P = MatIntFnc(P_P*z_P,np.array([fem_mu0,q]))
